/**
 * 内置 SVG 图标集（lucide 风格线性图标）
 * 占位符 __C__ = 描边颜色，__W__ = 描边宽度
 * 通过 data URI 渲染，H5 / 小程序均可用
 */
const wrap = (inner) =>
  `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='__C__' stroke-width='__W__' stroke-linecap='round' stroke-linejoin='round'>${inner}</svg>`

export const icons = {
  'chef-hat': wrap(`<path d='M17 21a1 1 0 0 0 1-1v-5.35c0-.457.316-.844.727-1.041a4 4 0 0 0-2.134-7.589 5 5 0 0 0-9.186 0 4 4 0 0 0-2.134 7.588c.411.198.727.585.727 1.041V20a1 1 0 0 0 1 1Z'/><path d='M6 17h12'/>`),
  briefcase: wrap(`<rect x='2' y='7' width='20' height='14' rx='2'/><path d='M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16'/>`),
  'clipboard-list': wrap(`<rect x='8' y='2' width='8' height='4' rx='1'/><path d='M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2'/><path d='M12 11h4'/><path d='M12 16h4'/><path d='M8 11h.01'/><path d='M8 16h.01'/>`),
  'document-text': wrap(`<path d='M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z'/><path d='M14 2v6h6'/><path d='M16 13H8'/><path d='M16 17H8'/><path d='M10 9H8'/>`),
  calendar: wrap(`<rect x='3' y='4' width='18' height='18' rx='2'/><path d='M16 2v4'/><path d='M8 2v4'/><path d='M3 10h18'/>`),
  compass: wrap(`<circle cx='12' cy='12' r='10'/><path d='m16.24 7.76-2.12 6.36-6.36 2.12 2.12-6.36z'/>`),
  bag: wrap(`<path d='M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z'/><path d='M3 6h18'/><path d='M16 10a4 4 0 0 1-8 0'/>`),
  ...
  building: wrap(`<path d='M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z'/><path d='M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2'/><path d='M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2'/><path d='M10 6h4'/><path d='M10 10h4'/><path d='M10 14h4'/><path d='M10 18h4'/>`),
  ...
  star: wrap(`<path d='M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z'/>`),
  send: wrap(`<path d='m22 2-7 20-4-9-9-4Z'/><path d='M22 2 11 13'/>`),
  clock: wrap(`<circle cx='12' cy='12' r='10'/><path d='M12 6v6l4 2'/>`),
  wallet: wrap(`<path d='M21 12V7H5a2 2 0 0 1 0-4h14v4'/><path d='M3 5v14a2 2 0 0 0 2 2h16v-5'/><path d='M18 12a2 2 0 0 0 0 4h4v-4Z'/>`),
  ...
  store: wrap(`<path d='M3 21h18'/><path d='M3 10h18'/><path d='M5 6 7.5 3h9L19 6'/><path d='M4 10v11'/><path d='M20 10v11'/><path d='M8 14h3v7H8z'/>`),
}
